  ...
  public void execute() {
	  ...
	  if(haveTarget == 0 && hadTarget == 0) {
		...
		if(	Math.abs(Robot.robotContainer.getDriverAxis(Axis.LEFT_Y)) >= .05) {
            RobotContainer.drive.arcadeDrive(Robot.robotContainer.getDriverAxis(Axis.LEFT_Y)*.65, rotateValue);
		} else if(Math.abs(Robot.robotContainer.getDriverAxis(Axis.RIGHT_Y)) >= .15) {
            RobotContainer.drive.arcadeDrive(Robot.robotContainer.getDriverAxis(Axis.RIGHT_Y)*.3, rotateValue);
		} else {
			RobotContainer.drive.arcadeDrive(0, rotateValue);	
		}
	  }
...
// 	if(	Math.abs(Robot.robotContainer.getDriverAxis(Axis.LEFT_Y)) >= .05) {
// 		Robot.drive.arcadeDrive(Robot.robotContainer.getDriverAxis(Axis.LEFT_Y)*.65, output);
// 	} else if(Math.abs(Robot.robotContainer.getDriverAxis(Axis.RIGHT_Y)) >= .15) {
// 		Robot.drive.arcadeDrive(Robot.robotContainer.getDriverAxis(Axis.RIGHT_Y)*.3, output);
// 	} else {	
